...
const ChatWindow = ({ generatedUIId, isOpen, onClose }: Props) => {
  ...
  return (
    <div
      className={cn(
        "fixed right-5 top-1/2 transform -translate-y-1/2 w-96 h-150 backdrop-blur-xl bg-white/10 border border-white/10 rounded-lg z-50 transition-all duration-300 flex flex-col",
