...
const ToolBarShapes = () => {
  ...
  return (
    <div className="col-span-1 flex justify-center items-center">
      <div className="flex items-center backdrop-blur-xl backdrop-[url('#displacementFilter')] border border-white/12 gap-2 rounded-full p-3 saturate-150 bg-white/8">
        {tools.map((tool) => (
          <Button
            key={tool.id}
            variant="ghost"
