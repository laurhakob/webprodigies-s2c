...
const UploadStatus = (image: UploadStatusProps) => {
  if (image.uploading) {
    return (
...
const ImagesBoard = ({
  ...
  return (
    ...
    >
      <div className="relative w-40 h-48 rounded-2xl overflow-hidden bg-white shadow-lg border border-gray-300 hover:scale-105 transition-all duration-200">
        <Image
          src={image.preview}
